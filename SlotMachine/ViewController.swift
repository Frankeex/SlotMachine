...
//  SlotMachine
//
//  Created by Frank Lucisano on 6/11/2014.
...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        setupFourthcContainer(fourthContainer)
        
        hardReset() //which calls setupSecondContainer
    ...
    func betOneButtonPressed(button: UIButton){
        if credits <= 0 {
            showAlertWithText(header: "Not enough credits", messsage: "Reset Game")
        } else {
            if currentBet < 5 {
                currentBet += 1
                credits -= 1
                ...
                showAlertWithText(messsage: "You can only bet a maximum of 5 credits at a time")
            }
        }
    }
    ...
    func betMaxButtonPressed(button: UIButton){
        if currentBet == 5 {
            showAlertWithText(header: "High Roller Alert!", messsage: "You are already betting the maximum")
        } else {
            if credits >= 5 {
    ...
    func setupFourthcContainer(containerView: UIView){
        self.resetButton = UIButton()
        self.resetButton.setTitle("Reset", forState: UIControlState.Normal)
        self.resetButton.setTitle("Sure?", forState: UIControlState.Highlighted)  //fancy addition
        self.resetButton.setTitleColor(UIColor.blueColor(), forState: UIControlState.Normal)
        self.resetButton.setTitleColor(UIColor.redColor(), forState: UIControlState.Highlighted) //fancy addition
        ...
        self.betOneButton.setTitle("Sure?", forState: UIControlState.Highlighted)  //fancy addition
        self.betOneButton.setTitleColor(UIColor.blueColor(), forState: UIControlState.Normal)
        self.betOneButton.setTitleColor(UIColor.redColor(), forState: UIControlState.Highlighted) //fancy addition
        ...
        spinButton.backgroundColor = UIColor.redColor()
